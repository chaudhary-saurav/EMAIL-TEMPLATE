...
<title>Email With Using Template</title>
</head>
				...
				<table width="600" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="center" valign="top" bgcolor="#d3be6c"
							...
							<div>
								<br> Email Template Sending Using Freemaker It 
                                can send <br> 'how to' about latest technology trends like<br>
